...
export const apps = {
  ...
  'cache-cleaner': {
    ...
    website_url: 'https://cssnr.github.io/cache-cleaner/',
  ...
  'github-extension': {
    ...
    github_url: 'https://github.com/smashedr/github-extension',
    icon: 'https://raw.githubusercontent.com/smashedr/github-extension/master/src/assets/icon.svg',
    redirect_url: 'https://github.com/smashedr/github-extension/issues',
    broken_text: 'Please provide a link to the site that is not functioning.',
  },
  'wxt-extension': {
    id: 'wxt-extension',
